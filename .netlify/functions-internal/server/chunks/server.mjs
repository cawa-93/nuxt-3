...
import { u as useRuntimeConfig$1 } from './aws-lambda.mjs';
...
const components = {};
function componentsPlugin_5fd790eb(nuxtApp) {
...
const vueuseHead_04aaa60d = defineNuxtPlugin((nuxtApp) => {
...
const plugin_24801801 = defineNuxtPlugin((nuxtApp) => {
...
const router_63c0369e = defineNuxtPlugin((nuxtApp) => {
  const routes = [];
  const hooks = {
    "navigate:before": [],
    "resolve:before": [],
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(_attrs)}> Hello world </div>`);
}
